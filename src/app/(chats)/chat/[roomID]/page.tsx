...
export default function Component() {
  ...
  return (
    <div className="w-full h-screen grid grid-cols-1 md:grid-cols-2 bg-background text-foreground">
      <div className={showRoomDetails ? 'col-span-1 hidden md:block' : 'col-span-2'}>
        <ChatRoom toggleShowRoomDetails={toggleShowRoomDetails} roomDetails={roomDetails} />
      </div>
